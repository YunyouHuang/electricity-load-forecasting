...
def plot_comparison(expected_output, predicted_output, plot_num=1, algorithm="k-means", zone_id=1):
...
if __name__ == "__main__":
    ...
    plot_origin(length_load, time_load, load_load, 21, u"用电负荷历史数据：zone-", u"用电量/kWh")
    ...
    #plot_comparison(outputs_full,outputs, plot_num=21)